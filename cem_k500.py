...
run = neptune.init(project='wonderit/maxwellfdfd-ll4al',
                   tags=['margin0.1', 'sub20000', 'no-init', 'k500'],
...
if __name__ == '__main__':
    ...
    for trial in range(PARAMS['trials']):
        ...
        for cycle in range(PARAMS['cycles']):
            ...
            optim_backbone = optim.AdamW(models['backbone'].parameters(), lr=PARAMS['lr'], weight_decay=PARAMS['weight_decay'])
            optim_module   = optim.Adam(models['module'].parameters(), lr=PARAMS['lr'], weight_decay=PARAMS['weight_decay'])
